...
# (ii) revelio_data/linked_revelio_data.csv -- Revelio labs:
...
#=====================================================================
# 2 - query the job positions data (@RYAN: commented out)
#=====================================================================

# # 131296 unique user id's
# user_ids <- readLines(file.path(PATH_TO_REVELIO, "tuscaloosa_student_id_list.txt"))
# 
...
# 
# fwrite(job_spell_ua_dt, file.path(PATH_TO_REVELIO, "job_spells_data_ua.csv"))

#=====================================================================
# 3 - find the analysis sample by restricting to post 2006 / bachelors
#=====================================================================

### (i) CHECK THE JOB SPELL DATA (post 2006 jobs)

job_spell_ua_dt <- fread(file.path(PATH_TO_REVELIO, "job_spells_data_ua.csv"))
...
all_ua_students <- fread(file.path(PATH_TO_REVELIO, "revelio_tuscaloosa_students.csv"))
# post 2006
...
ua_profiles_dt <- fread(file.path(PATH_TO_REVELIO, "revelio_ua_student_names.csv"))
...
fwrite(combined_names_ua_dt, file.path(PATH_TO_REVELIO, "linked_revelio_data.csv"))
